      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table">
        <TableHead>
          <StyledTableRow>
              ...
              <StyledTableCell align="right" sx={{float: 'right'}}>Profit</StyledTableCell>
          </StyledTableRow>
        </TableHead>
        <TableBody>
          {rows.map((row, index) => (
            <StyledTableRow key={index}>
              ...
              <StyledTableCell width={"150px"} component="th" scope="row"><IDChip label={row.id} /></StyledTableCell>
