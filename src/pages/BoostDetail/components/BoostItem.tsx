...
const RadialBackground = styled(Box)(({ theme }) => ({
  ...
  borderRadius: "50%",
  backgroundImage:
    "radial-gradient(50% 50% at 50% 50%, #454B52 0%, #272C32 100%)",
  justifyContent: "center",
  paddingTop: "32px",
  zIndex: 4,
}));
...
const levelColors = ["#596AFF", "#FF6A55", "#FDE048"];

const fontColors = ["#000", "#fff"];
    ...
    <Box display={"flex"} flexDirection={"column"} gap={3}>
        ...
        {item && (
          <Fragment>
            ...
            <RadialBackground>
              ...
              >
                <FlexBox>
                  <RootTypography fontSize={{ xs: 24, sm: 32 }}>
                    {item?.id}
                  </RootTypography>
                </FlexBox>
                <FlexBox>
              ...
              >
                <RootCircle bgcolor={"white"} borderColor={"white"}>
                  <RootTypography color={"black"} sx={{ fontSize: "20px" }}>
                    1213123
                  </RootTypography>
                </RootCircle>
                <RootCircle bgcolor={"#73777d"} borderColor={"white"} />
              ...
              >
                <FlexBox gap={1} justifyContent={"center"}>
                  <FlexBox gap={"4px"}>
                    ...
                    <RootTypography sx={{ fontSize: "20px" }}>
                      {item?.users}
                    </RootTypography>
                  </FlexBox>
                  <FlexBox gap={"4px"}>
                ...
                <FlexBox gap={2} justifyContent={"center"}>
                  <RootTypography sx={{ fontSize: "15px" }}>
                    Total level revenue:
                  </RootTypography>
                  <FlexBox gap={1}>
                    <TokenImg src={HeheImg} />
            ...
            <TopCircle bgcolor={levelColors[item?.level - 1]}>
              <RootTypography color={fontColors[item?.level % 3]}>
                lvl {item?.level}
              </RootTypography>
            </TopCircle>
          </Fragment>
      ...
      >
        <RootCircle bgcolor={"#fff"} borderColor={"#111315"} gap={1}>
          ...
          <RootTypography sx={{ fontSize: "13px" }} color={"black"}>
            Level 1
          </RootTypography>
        </RootCircle>
        <RootCircle bgcolor={"#fff"} borderColor={"#111315"} gap={1}>
